...
def main():
    ...
    with open("test2_qs_ferdesik.txt") as f:
    ...
    mesured_index = 4   # hanyadikat adat eseten merunk
...
#    print(qs_data[mesured_index])
    ...
    print("Aktuális csuklószögek   (radián):", repr(current_joint_positions)) # ezt hasonlitani azzal, amit en adtam neki
    print("Beállított csuklószögek (radián):", repr(qs_data[mesured_index])) # amit én adtam neki
    print("Kulonbseg: " , np.float128(current_joint_positions) -np.float128(qs_data[mesured_index]))
    print("Kulonbseg: " , current_joint_positions == qs_data[mesured_index])
